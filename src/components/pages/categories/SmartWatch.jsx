    ...
    <>
      ...
      <main className="bg-[#f1f1f1] mt-[100px] lg:mt-[120px]">
        <div className="header py-6 mx-auto text-center">
          <h1 className="text-6xl font-bold text-black mb-3 italic">Smart Watch</h1>
          <p className="text-[#8D8D8D]">Discover top electronics: gadgets, devices, accessories, and cutting-edge technology.</p>
        </div>
        <div className="filter md:w-fit w-[90%] mx-auto py-6">
          <h6 className="text-[18px] text-[#373737] w-fit">filter by</h6>
          <form action="" className="md:w-[1100px] w-full bg-white px-8 py-4 grid md:grid-cols-2 grid-cols-1 items-center gap-4 rounded-[16px] shadow-xl">
            <div className="col flex md:flex-row flex-col md:items-center gap-4">
              <div className="label">
                <label htmlFor="" className="text-[18px] font-bold">Price</label>
                <p className="text-[14px]">Enter Price Range</p>
              </div>
              <div className="flex gap-2">
                <input type="text" placeholder="From" className="px-6 py-2 bg-[#F4F4F4] w-[130px] text-center rounded shadow-md placeholder:text-[#8A8A8A]" />
                <span className="text-[18px] font-bold text-[#4D4D4D]">-</span>
                <input type="text" placeholder="To" className="px-6 py-2 bg-[#F4F4F4] w-[130px] text-center rounded shadow-md placeholder:text-[#8A8A8A]" />
              </div>
            </div>
            <div className="col flex md:flex-row flex-col md:items-center gap-4">
              <div className="label">
                <label htmlFor="" className="text-[18px] font-bold">Brand</label>
                <p className="text-[14px]">Enter What Brand</p>
              </div>
              <input type="text" placeholder="Enter Your brand" className="px-6 py-2 bg-[#F4F4F4] rounded shadow-md placeholder:text-[#8A8A8A] flex-1" />
              <button className="px-5 py-3 rounded-[16px] bg-primary text-white text-xl transition-all hover:text-primary hover:bg-white font-semibold w-fit">Go</button>
            </div>
          </form>
        </div>
