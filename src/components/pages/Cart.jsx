...
const Cart = () => {
	...
	if (loading) {
		return (
			<div className="min-h-[50vh] mt-[145px] lg:mt-[140px] flex items-center justify-center text-xl">
				Loading...
			</div>
		);
	}
		...
		<main className="mt-[145px] lg:mt-[140px] mb-12">
			...
			<div className="container grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
				<div className="content col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2">
					{cart?.data?.cartItems[0] !== undefined ? (
									...
									<div className="bottom mt-6 flex items-center justify-between md:w-[90%]">
										<div className="price">
											...
											<div className="price-details flex items-center sm:gap-4 gap-2">
												...
												<h6 className="sm:text-lg text-[12px] text-[#2ecc71]">
										...
										<div className="tools flex items-center gap-4">
											...
											<button
												onClick={() =>
													handleRemove(cart?.data?.cartItems[index]._id)
												}
				...
				<div className="details p-4 rounded-md bg-white h-fit w-full lg:w-[400px] mx-auto sm:mb-0 mb-[25px]">
					...
					<div className="total mx-4 my-2">
						<p className="text-xl font-semibold">
							Total{" "}
							<span className="text-[#717171] ml-2 font-medium">
								(Inclusive of VAT)
							</span>
						</p>
						<h4 className="mt-2">
